        ...
        <div className={styles.marketingPage} dir={lang === 'ar' ? 'rtl' : 'ltr'}>
                        ...
                        <table className={styles.dataTable}>
                            <thead>
                                <tr>
                                    ...
                                    <th style={{ textAlign: lang === 'ar' ? 'right' : 'left' }}>
                                        {t('marketing.colValue')}
                                    </th>
                                    <th style={{ textAlign: lang === 'ar' ? 'right' : 'left' }}>
                                        {t('marketing.colMinSpend')}
                                    </th>
                                    <th style={{ textAlign: lang === 'ar' ? 'right' : 'left' }}>
                                        {t('marketing.colUsage')}
                                    </th>
                                    <th style={{ textAlign: lang === 'ar' ? 'right' : 'left' }}>
                                        {t('marketing.colStatus')}
                                    </th>
                                    <th style={{ textAlign: lang === 'ar' ? 'right' : 'left' }}>
                                        {t('marketing.colExpires')}
                                    </th>
                                    <th></th>
                                </tr>
                            </thead>
            ...
            {activeTab === 'campaigns' && (
                ...
                >
                    <Send
                        size={48}
                        style={{ margin: '0 auto var(--space-4)', color: 'var(--text-tertiary)', opacity: 0.4 }}
                    />
                    <div
                        style={{
            ...
            >
                <div style={{ display: 'flex', flexDirection: 'column', gap: 'var(--space-4)' }}>
                        ...
                        <Input
                            ...
                            defaultValue={
                                selectedOffer?.validUntil
                                    ? new Date(selectedOffer.validUntil).toISOString().split('T')[0]
                                    : ''
                            }
                            style={{ flex: 1 }}
                        />
                    ...
                    <Select
                        ...
                        value={selectedOffer?.status || 'active'}
                        options={[
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: 'var(--space-4)' }}>
                    ...
                    <div style={{ display: 'flex', gap: 'var(--space-3)' }}>
                        <Select
                            ...
                            value={selectedPromo?.type || 'Percentage'}
                            style={{ flex: 1 }}
                            options={[
                    ...
                    <div style={{ display: 'flex', gap: 'var(--space-3)' }}>
                        <Input
                            ...
                            type="number"
                            defaultValue={selectedPromo?.minSpend}
                            style={{ flex: 1 }}
                            dir="ltr"
                        />
                        <Input
                            ...
                            type="number"
                            defaultValue={selectedPromo?.maxUses}
                            style={{ flex: 1 }}
                            dir="ltr"
                        />
                    </div>
                    <Input
                        ...
                        defaultValue={
                            selectedPromo?.expires ? new Date(selectedPromo.expires).toISOString().split('T')[0] : ''
                        }
                    />
                    <Select
                        label={t('marketing.modal.status')}
                        value={selectedPromo?.status || 'active'}
                        options={[
                            { label: t('marketing.filterActive'), value: 'active' },
                            { label: t('marketing.filterScheduled'), value: 'scheduled' },
                            { label: t('marketing.filterExpired'), value: 'expired' },
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: 'var(--space-4)' }}>
                    ...
                    <div>
                        ...
                        <div style={{ display: 'flex', gap: 'var(--space-4)' }}>
                            ...
                            >
                                <input type="checkbox" defaultChecked={selectedMsg?.channels.includes('whatsapp')} />{' '}
                                WhatsApp
                            </label>
                            <label
                                style={{
                    ...
                    >
                        <input type="checkbox" defaultChecked={selectedMsg?.enabled ?? true} />{' '}
