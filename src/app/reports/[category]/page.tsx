...
const getRevenueData = () => ({
    ...
    reports: [
        { title: 'Daily Revenue', href: '/reports/revenue/daily-revenue', desc: 'Breakdown of revenue by day.' },
        {
            ...
            desc: 'Cash vs Card vs Transfer analysis.',
        },
        {
            title: 'Service Revenue',
            href: '/reports/revenue/service-revenue',
            desc: 'Revenue generated by each service.',
        },
...
const getBookingsData = () => ({
    ...
    reports: [
        { title: 'Booking History', href: '/reports/bookings/history', desc: 'Full log of all appointments.' },
        {
            ...
            desc: 'Analysis of cancelled appointments.',
        },
    ...
    reports: [
        {
            ...
            desc: 'Cross-metric comparison of revenue and bookings.',
        },
        {
            title: 'Employee Efficiency',
            href: '/reports/custom/employee-efficiency',
            desc: 'Revenue per hour per employee analysis.',
        },
        {
            title: 'Client Lifetime Value',
            href: '/reports/custom/client-ltv',
            desc: 'Projected lifetime value by segment.',
        },
        {
            title: 'Monthly Summary',
            href: '/reports/custom/monthly-summary',
            desc: 'Executive summary for stakeholders.',
        },
    ],
});
...
export default function ReportCategoryPage({ params }: { params: Promise<{ category: string }> }) {
    ...
    const fallbackApiData: ReportData = {
        ...
        datasets: [{ label: fallbackData.chart.title, data: fallbackData.chart.data.map(d => d.value) }],
        summary: {},
    };
