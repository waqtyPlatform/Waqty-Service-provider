...
const fallbackReturns = [
    {
        ...
        time: '10:30',
        type: 'service',
        originalTxn: 'TXN-2045',
        client: 'Huda Saleh',
        item: 'Gel Manicure',
        reason: 'Client dissatisfied with result',
        amount: 130,
        basePrice: 150,
        priceSource: 'tier',
        method: 'Cash',
    ...
    },
    {
        ...
        time: '11:45',
        type: 'service',
        originalTxn: 'TXN-2028',
        client: 'Noura Ahmed',
        item: 'Swedish Massage',
        reason: 'Service not completed – emergency',
        amount: 350,
        basePrice: 350,
        priceSource: 'base',
        method: 'Cash',
    ...
    },
    {
        ...
        time: '13:00',
        type: 'advance',
        originalTxn: 'TXN-2025',
        client: 'Rania Khalil',
        item: 'Bridal Package Down Payment',
    ...
    },
    {
        ...
        time: '16:30',
        type: 'petty',
        originalTxn: 'TXN-2015',
        client: '—',
        item: 'Petty Cash Refund – Supplier Overcharge',
        reason: 'Vendor corrected invoice',
        amount: 120,
        basePrice: 120,
        priceSource: 'base',
        method: 'Internal',
    ...
    },
    {
        ...
        time: '12:00',
        type: 'service',
        originalTxn: 'TXN-2010',
        client: 'Maryam Ibrahim',
        item: 'HydraFacial',
        reason: 'Double booking – service cancelled',
        amount: 600,
        basePrice: 600,
        priceSource: 'base',
        method: 'Card',
...
export default function ReturnsPage() {
    ...
    const statusConfig: Record<string, { bg: string; color: string; label: string; icon: React.ReactNode }> = {
        approved: {
            ...
            label: t('rtn.lblApproved'),
            icon: <CheckCircle2 size={12} />,
        },
        pending: {
            bg: 'var(--color-warning-light)',
            color: 'var(--color-warning)',
            label: t('rtn.lblPending'),
            icon: <Clock size={12} />,
        },
        rejected: {
            bg: 'var(--color-error-light)',
            color: 'var(--color-error)',
            label: t('rtn.lblRejected'),
        ...
        <div className={styles.page} style={{ direction: lang === 'ar' ? 'rtl' : 'ltr' }}>
            <div className={styles.header}>
                ...
                <button className={styles.btnP}>
                    <Plus size={16} className={lang === 'ar' ? 'ml-2' : 'mr-2'} /> {t('rtn.newBtn')}
                </button>
            </div>
            ...
            <div className={styles.kpiRow}>
                ...
                <div className={styles.kpi}>
                    ...
                    <div
                        className={`${styles.kpiV} ${styles.kpiVError}`}
                        dir="ltr"
                ...
                <div className={styles.kpi}>
                    ...
                    <div className={styles.kpiV} dir="ltr" style={{ textAlign: lang === 'ar' ? 'right' : 'left' }}>
                        1.2 {lang === 'ar' ? 'أيام' : 'days'}
                    </div>
                </div>
            </div>
