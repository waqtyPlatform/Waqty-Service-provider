...
export default function EmployeeRolesPage() {
    return (
        <div style={{ display: 'flex', flexDirection: 'column', gap: 'var(--space-5)' }}>
            <div>
                <h1 style={{ fontSize: 'var(--text-2xl)', fontWeight: 'var(--font-bold)' }}>Employee Roles</h1>
            ...
            <div style={{ background: 'var(--bg-primary)', border: '1px solid var(--border-color)', borderRadius: 'var(--radius-xl)', padding: 'var(--space-12)', textAlign: 'center' }}>
                ...
                <h2 style={{ fontSize: 'var(--text-xl)', fontWeight: 'var(--font-semibold)', marginBottom: 'var(--space-2)' }}>Job Roles</h2>
                <p style={{ color: 'var(--text-tertiary)', maxWidth: 400, margin: '0 auto' }}>
                    Manage standardized role definitions and hierarchies.
                </p>
